...
with st.expander('Polígonos', expanded=True):
    ...
    if len(poligonos) > 0:
        ...
        general_ = general.loc[general.id_polygon==desc_poly, ['Tipo', 'Indicador', 'Valor']].set_index('Tipo')
        modal_ = modal.loc[modal.id_polygon==desc_poly, ['Tipo', 'Indicador', 'Valor']].set_index('Tipo')
        distancias_ = distancias.loc[distancias.id_polygon==desc_poly, ['Tipo', 'Indicador', 'Valor']].set_index('Tipo')
