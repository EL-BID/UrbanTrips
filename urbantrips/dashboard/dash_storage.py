...
def resolve_db_aliases(configs: dict) -> dict:
    """Return the alias prefix for each DB type, mirroring run_process.py logic.

    Priority:
      alias_db_insumos > alias_db  (for insumos)
      alias_db         > alias_db_insumos  (for data / dash / general)
    Per-corrida autogenerated keys (alias_db_data, alias_db_dashboard) take
    precedence over the base alias_db when present.
    """
