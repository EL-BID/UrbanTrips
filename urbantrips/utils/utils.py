...
def leer_configs_generales(autogenerado=True):
    ...
    if env_path and not autogenerado:
        # Custom config only applies to base reads; autogenerated reads always
        # use the standard autogenerated path so check_config() output is found.
        path = env_path
    else:
        archivo = (
