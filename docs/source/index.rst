...
Para una discusión metodológica de cómo se imputan destinos y se construye la matriz de origen y destino se puede consultar este `documento metodológico <https://github.com/EL-BID/UrbanTrips/blob/main/docs/Metodologia_UrbanTrips.pdf>`_ 
